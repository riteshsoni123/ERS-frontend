    ...
    <div className="container" id="home">
      <div className="row">
        <div className="col-lg-6 entry">
          ...
          <h4>
            Don't mess with us. We've got<span> Robots</span>
          </h4>
          <p>
            "Robots are interesting because they exist as a real technology that
            you can really study - you can get a degree in robotics - and they
